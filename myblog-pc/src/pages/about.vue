	...
	<div class="about">
		<el-row class="main" type="flex" justify="center">
			<el-col :span="16">
				...
				<div class="statement">
					<div class="item">Email：965329780@qq.com</div>
					<div class="item">QQ：965329780</div>
					<div class="item">CSDN：
						<a target="_blank" href="https://blog.csdn.net/hjp965329780?spm=1000.2115.3001.5343">https://blog.csdn.net/hjp965329780?spm=1000.2115.3001.5343</a>
					</div>
				</div>
